          ...
          <div id={styles.imgbox}>
            ...
            animate={{ rotate: rotations[ci] }} 
             ...
             <motion.div  style ={{height:'200px'}} animate={{ rotate: rotations[ci] }} >
              ...
              <motion.div animate={{ rotate: rotations[ci] }}>
                <Image src={astroframe} className={styles.astroimage2} />
              </motion.div>
            ...
            >
              <ul className={styles.para}>
                <li>
                  ...
                  Duis qui id aliquip cillum incididunt in. Nisi mollit do
                  nostrud sunt Lorem ullamco cillum fugiat ut sint. Aute laboris
                  incididunt elit et anim..
                </li>
                <li>
                  Veniam cupidatat commodo elit pariatur adipisicing.
                  Adipisicing esse in dolore excepteur. Deserunt magna eiusmod
                  culpa mollit duis.
                </li>
                <li>
